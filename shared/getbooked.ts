...
export const BROWSE_PROFILES: ProfileCard[] = [
  ...
  {
    id: "promoter-northstar-presents",
    role: "promoter",
    name: "Northstar Presents",
    slug: "northstar-presents",
    city: "Austin",
    country: "USA",
    tagline: "Independent promoter team scaling club, theater, and outdoor bookings across Texas.",
    primaryMeta: "Regional Promoter",
    secondaryMeta: "Books indie, alt-pop, and crossover shows",
    priceLabel: "Club to theater routing",
    accent: ROLE_CONFIG.promoter.accent,
    imageUrl: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=900&q=80",
    filters: { city: "Austin" },
  },
  {
    id: "promoter-afterglow-live",
    role: "promoter",
    name: "Afterglow Live",
    slug: "afterglow-live",
    city: "Brooklyn",
    country: "USA",
    tagline: "Boutique promoter collective focused on premium album-release events and cultural collaborations.",
    primaryMeta: "Boutique Promoter",
    secondaryMeta: "Strong with launch campaigns and destination nights",
    priceLabel: "Launches and special events",
    accent: ROLE_CONFIG.promoter.accent,
    imageUrl: "https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=900&q=80",
