      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <MockupFrame>
          <div className="relative">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 select-none p-4" style={{ filter: "blur(6px)" }} aria-hidden="true">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
              <div className="rounded-2xl border border-primary/20 bg-background/95 backdrop-blur-md px-8 py-8 text-center max-w-sm mx-4 shadow-[0_0_60px_-12px_hsl(var(--primary)/0.15)]">
                ...
                <Link to="/pricing">
                  <Button className="bg-primary text-primary-foreground hover:bg-primary/90 text-xs font-display font-semibold active:scale-[0.96] transition-transform lowercase h-11 px-7 shadow-[0_0_24px_rgba(200,255,62,0.25)]">
