  ...
  return (
    <section className="fade-in-section py-28 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div
          className="rounded-2xl border border-white/[0.07] backdrop-blur-[12px] p-7 sm:p-10 transition-all duration-300"
        ...
        >
          ...
          <Link to="/auth?tab=signup" className="inline-block mt-8">
            <Button size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90 text-xs font-display font-semibold active:scale-[0.96] transition-transform lowercase h-10 px-6 shadow-[0_0_24px_rgba(200,255,62,0.25)]">
