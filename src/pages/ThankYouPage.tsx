...
export default function ThankYouPage() {
  ...
  return (
    <>
      ...
      <style>{`
        body.thankyou-page-active .skip-to-main,
        body.thankyou-page-active nav[aria-label="Main navigation"],
        body.thankyou-page-active #mobile-nav-panel,
        body.thankyou-page-active .fixed.top-0.left-0.right-0.z-50.h-\[60px\],
        body.thankyou-page-active .fixed.bottom-4.left-4.right-4.z-50 {
          display: none !important;
        }

        body.thankyou-page-active #main-content {
      ...
      <div className="min-h-screen bg-[#080C14] text-foreground flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-2xl rounded-[32px] border border-white/[0.08] bg-white/[0.03] shadow-[0_0_0_1px_rgba(255,255,255,0.02)] backdrop-blur-sm p-8 md:p-12 text-center">
          <img
            src={logoColor}
            alt="GetBooked.Live"
            className="h-7 w-auto mx-auto mb-8 opacity-100"
            loading="eager"
            fetchPriority="high"
          />
